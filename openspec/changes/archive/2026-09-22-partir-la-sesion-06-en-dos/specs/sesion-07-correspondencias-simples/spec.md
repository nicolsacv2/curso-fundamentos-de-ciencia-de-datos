...
contingencia de la entrada —del perfil a la nube, de la nube al plano—, con la distancia
...
del salón, y enunciar que las columnas raras pesan más.

#### Scenario: Dos filas, una distancia
- **WHEN** alguien lee la distancia chi-cuadrado
- **THEN** ve la fórmula
- **AND** ve su valor entre dos filas concretas de la tabla del salón
...
entrada dividido por el número de personas, mostrarlo con las cifras del salón, y que se
...
sobre una fila de la tabla del salón con sus cifras.
...
baricéntrica y no como una distancia euclídea— y aplicarlas a la tabla del salón.

#### Scenario: Las reglas están escritas y aplicadas
- **WHEN** alguien lee la interpretación del mapa
- **THEN** ve las reglas de lectura
- **AND** ve al menos una lectura sobre los niveles del salón que remite a una celda de la tabla observada contra la esperada
