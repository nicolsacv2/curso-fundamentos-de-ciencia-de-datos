...
Cubre la segunda mitad del bloque 1 de la sesión 6: qué le hace al MCA una categoría que
...
relacionar el primero con el agrupamiento en «raro» que la entrada ya aplicó.

#### Scenario: Cuatro remedios, y uno ya usado
- **WHEN** alguien lee los remedios
- **THEN** ve los cuatro
- **AND** se dice que fusionar es lo que la entrada hizo al agrupar los niveles de una persona
