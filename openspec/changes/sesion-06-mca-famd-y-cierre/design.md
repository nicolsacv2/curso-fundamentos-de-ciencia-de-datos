...
ninguna más, scripts de Python de stdlib pura salvo `clean_salon.py`, un `import()` por
...
- Antes de mergear: `pnpm build`, `python3 scripts/check_salon.py`,
  `python3 scripts/ejemplo_mca_famd.py` (dos veces, `diff` vacío),
