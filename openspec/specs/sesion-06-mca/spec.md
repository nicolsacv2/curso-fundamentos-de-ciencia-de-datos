# sesion-06-mca Specification

## Purpose

Cubre el bloque 2 de la sesión 7: la matemática del análisis de correspondencias múltiples
—el análisis de correspondencias del bloque 1 sobre la tabla indicadora— enseñada sobre un
ejemplo de ocho personas, de la tabla disyuntiva completa a las herramientas de
interpretación, con todas sus cifras generadas y verificadas, y los conceptos «en versión
humana» con el protocolo de lectura en cuatro pasos. La capacidad conserva su nombre de
cuando este contenido era el bloque 1 de la sesión 6.
