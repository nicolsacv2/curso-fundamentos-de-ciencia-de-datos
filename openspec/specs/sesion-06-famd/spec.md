# sesion-06-famd Specification

## Purpose

Cubre el bloque 3 de la sesión 7: cómo el análisis factorial de datos mixtos mezcla
variables numéricas y categóricas sin que ninguna domine por aritmética, verificado sobre
las mismas ocho personas del bloque 2, cómo se calculan sus indicadores, y los tres gráficos
con los que se lee y en qué orden. La capacidad conserva su nombre de cuando este contenido
era el bloque 2 de la sesión 6.
...
enunciar que el método viene implementado en los programas estadísticos habituales, sin
nombrar lenguajes de programación ni paquetes.
...
- **AND** se dice que el método está en los programas estadísticos habituales, sin nombrar ninguno
