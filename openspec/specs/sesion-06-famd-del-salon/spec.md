# sesion-06-famd-del-salon Specification

## Purpose

Cubre el cierre de la sesión 7: el análisis factorial de datos mixtos aplicado a la tabla
del salón que la sesión 6 dejó limpia, leído con el protocolo del bloque 2 y los tres
gráficos del bloque 3, comparado con el PCA de la sesión 6, con las categorías de una sola
persona y las marcas de celda inventada proyectadas como suplementarias; y el ticket de
salida con el puente a la sesión siguiente. La capacidad conserva su nombre de cuando este
contenido cerraba la sesión 6.
