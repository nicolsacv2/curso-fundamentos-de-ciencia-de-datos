...
export const METAS = [meta01, meta02, meta03, meta04, meta05, meta06];
...
export const BLOCKS = {
  ...
  4: {
    'entrada':  () => import('./s04/blocks/Intro.jsx'),
    'bloque-1': () => import('./s04/blocks/Block1.jsx'),
    'bloque-2': () => import('./s04/blocks/Block2.jsx'),
    'bloque-3': () => import('./s04/blocks/Block3.jsx'),
    'cierre':   () => import('./s04/blocks/Closing.jsx')
  },
  5: {
    'entrada':  () => import('./s05/blocks/Intro.jsx'),
    'bloque-1': () => import('./s05/blocks/Block1.jsx'),
